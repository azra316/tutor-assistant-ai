      ...
      <div className="min-w-0">
        <header className="sticky top-0 z-20 border-b border-slateboard/10 bg-chalk/90 backdrop-blur">
          <div className="flex min-h-20 items-center gap-3 px-4 sm:px-6 lg:px-8">
            <button
              className="ui-button ui-button-secondary grid size-11 min-h-0 place-items-center p-0 lg:hidden"
              type="button"
            ...
            <div className="min-w-0 flex-1">
              ...
              <h1 className="ui-text-heading truncate text-xl sm:text-2xl">
                {page.title}
              </h1>
            </div>

            {user && (
              <div className="ui-surface hidden min-h-11 items-center gap-2 rounded-lg px-3 text-sm font-bold shadow-sm sm:flex">
            ...
            <button
              className="ui-button ui-button-secondary grid size-11 min-h-0 place-items-center p-0"
              type="button"
            ...
            <button
              className="ui-button ui-button-secondary grid size-11 min-h-0 place-items-center p-0 text-coral hover:bg-coral/10"
              type="button"
              aria-label="Logout"
              onClick={onLogout}
            >
